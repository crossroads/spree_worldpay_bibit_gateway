...
desc 'Generate documentation for the rbs_worldpay_bibit_gateway extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'RbsWorldpayBibitGatewayExtension'
...
desc 'Test the rbs_worldpay_bibit_gateway extension.'
